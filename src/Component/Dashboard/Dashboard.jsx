        ...
        <div className="max-w-6xl mx-auto my-5 p-5 bg-white border border-gray-100 shadow-md rounded-lg">
          ...
          <div className="flex justify-between items-center mb-5">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="/Pages/form.html">
                <button className="bg-[#8BC34A] text-white border-none rounded px-5 py-2.5 text-base hover:bg-[#7CB342]">
                  Add User
                </button>
              </a>
            </div>
          ...
          <div className="mt-2.5 overflow-x-auto">
            {loading ? (
              ...
              <p className="p-3 text-center text-gray-500">No employees found</p>
            )}
          </div>
        </div>
      </div>
